...
from DBMock import Team_DBMock, Master_DBMock, Game_DBMock, Landmark_DBMock
import copy
...
class Test_Team(TestCase):
	...
	def test_login(self):
		self.assertEqual(self.mock.login("team2", "team2pass"),  {"userid" : 1, "name" : "team2", "pwd" : "team2pass"}, "team login didn't return team info")
...
class Test_Landmark(TestCase):
	...
	def test_fetch(self):
		self.assertEqual(self.l, self.mock.fetch(0,0), "Fetch failed to return a landmark")
