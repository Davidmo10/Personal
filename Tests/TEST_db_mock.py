...
from db_mock import DBMock, TeamDBMock, MasterDBMock, GameDBMock, LandmarkDBMock
from escavenger_db_exceptions import InvalidGameException, InvalidTeamException, InvalidLandmarkException, \
	InvalidUserException, InvalidGameStateException, InvalidTeamStateException, EmptyGameSetException, \
...
class StaticTests(TestCase):
	...
	def test_real_game(self):
		self.assertEqual(self.mock.fetch_game(0),
		                 {"game_id": 0, "title": "Pokemon", "desc": "Catch those fuckers", "master_id": 2, "on": 1,
		                  "landmarks": [{"landmark_id": 0, "title": "uwm", "desc": "blah uwm blah", "clue": "it's uwm",
		                                 "question": "am i uwm?", "answer": "yes"},
		                                {"landmark_id": 1, "title": "ems", "desc": "blah ems blah", "clue": "it's ems",
		                                 "question": "am i ems?", "answer": "yes"},
		                                {"landmark_id": 2, "title": "jimmy johns", "desc": "blah jimmy johns blah",
		                                 "clue": "it's jimmy johns", "question": "am i jimmy johns?", "answer": "yes"}],
		                  "teams": [{"team_id": 0,
		                             "events": [{"landmark_id": 0, "correct": 1}, {"landmark_id": 1, "correct": 0},
		                                        {"landmark_id": 1, "correct": 0}], "playing": 1}, {"team_id": 1,
		                                                                                           "events": [{
			                                                                                                      "landmark_id": 0,
			                                                                                                      "correct": 1},
		                                                                                                      {
			                                                                                                      ...
			                                                                                                      "correct": 0}, ],
		                                                                                           "playing": 1},
		                            {"team_id": 2, "events": [], "playing": 1}, {"team_id": 3, "events": [
				                  {"landmark_id": 0, "correct": 1}, {"landmark_id": 1, "correct": 1},
				                  {"landmark_id": 2, "correct": 1}], "playing": 1}]},
		                 "fetch_game to equate on real id = 0")
...
class TestGame(TestCase):
	...
	def test_fetch_landmarks(self):
		self.assertEqual(self.mock.fetch_landmarks(self.g["game_id"]), [
			{"landmark_id": 0, "title": "uwm", "desc": "blah uwm blah", "clue": "it's uwm", "question": "am i uwm?",
			 "answer": "yes"},
			{"landmark_id": 1, "title": "ems", "desc": "blah ems blah", "clue": "it's ems", "question": "am i ems?",
			 "answer": "yes"},
			{"landmark_id": 2, "title": "jimmy johns", "desc": "blah jimmy johns blah", "clue": "it's jimmy johns",
			 "question": "am i jimmy johns?", "answer": "yes"}], "fetch_landmark did not return the landmark")
	...
	def test_fetch_team_list(self):
		self.assertEqual(self.mock.fetch_team_list(self.g["game_id"]), [{"team_id": 0,
		                                                                 "events": [{"landmark_id": 0, "correct": 1},
		                                                                            {"landmark_id": 1, "correct": 0},
		                                                                            {"landmark_id": 1, "correct": 0}],
		                                                                 "playing": 1}, {"team_id": 1, "events": [
			{"landmark_id": 0, "correct": 1}, {"landmark_id": 1, "correct": 0}, ], "playing": 1},
		                                                                {"team_id": 2, "events": [], "playing": 1},
		                                                                {"team_id": 3,
		                                                                 "events": [{"landmark_id": 0, "correct": 1},
		                                                                            {"landmark_id": 1, "correct": 1},
		                                                                            {"landmark_id": 2, "correct": 1}],
		                                                                 "playing": 1}],
		                 "fetch_team_list did not return the list")
	...
	def test_fetch_team_status(self):
		self.assertEqual(self.mock.fetch_team_status(self.g["game_id"], self.t["team_id"]), {"team_id": 0, "events": [
			{"landmark_id": 0, "correct": 1}, {"landmark_id": 1, "correct": 0}, {"landmark_id": 1, "correct": 0}], "playing": 1}, "fetch_team_status did not return the right status")
